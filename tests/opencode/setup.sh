...
mkdir -p "$HOME/.config/opencode/sp-ecc"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/sp-ecc/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/sp-ecc/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/sp-ecc/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/sp-ecc.js" "$HOME/.config/opencode/sp-ecc/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/sp-ecc/.opencode/plugins/sp-ecc.js" \
       "$HOME/.config/opencode/plugins/sp-ecc.js"
...
echo "Plugin installed to: $HOME/.config/opencode/sp-ecc/.opencode/plugins/sp-ecc.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/sp-ecc.js"
