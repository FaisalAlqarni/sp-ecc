...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/sp-ecc
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/sp-ecc-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using sp-ecc:subagent-driven-development. The plan is at: $PLAN_PATH"
